...
_backgroundTaskEntrypoint() {
  AudioServiceBackground.run(() => AudioPlayerTaskTest());
}

class AudioPlayerTaskTest extends BackgroundAudioTask {
...
class HomePageAudio extends StatefulWidget {
  @override
  _HomePageAudioState createState() => _HomePageAudioState();
}

class _HomePageAudioState extends State<HomePageAudio> {
  @override
