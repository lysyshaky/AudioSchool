  ...
  void didChangeDependencies() {
    ...
    _sliderThemeData = SliderTheme.of(context).copyWith(
      ...
      activeTrackColor: isThemeDark
          ? yellowMain
          : blueMain, // Change this to the desired color
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Row(
          children: [
            Expanded(
              child: Stack(
                children: [
                  // ... (SliderTheme and other widgets, no changes here)
        ...
        Row(
          children: [
            SizedBox(width: 16), // Add space for the current time's position
            Expanded(
              child: Text(
